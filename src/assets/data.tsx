  ...
  {Array.from({ length: 6 }).map((_, i) => (
    <div className="max-w-sm m-2 mx-aut shadow bg-white dark:bg-gray-800 dark:shadow-lg dark:shadow-gray-700/50" key={i}>
      ...
      <div className="div p-2">
        <div className="mb-2">
          <h2 className="font-bold text-sm sm:text-base text-black dark:text-gray-100">Amazing Card</h2>
          <p className="text-gray-700 text-[0.6rem] sm:text-xs dark:text-gray-400">
            This is a description for the amazing card.
          </p>
        </div>
        <button className="px-2 sm:px-4 py-1 sm:py-2 bg-black text-white rounded text-[0.6rem] sm:text-xs cursor-pointer dark:bg-indigo-600 dark:text-white dark:hover:bg-indigo-700">Learn More</button>
      </div>
    </div>
  ))}
</div>
